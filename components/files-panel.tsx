...
const initial:Directory[]=[{id:'default',name:'我的案例',cases:[{id:'weather',name:'北京天气 / 跑步提醒'},{id:'actor',name:'演员名字 / 追问电视剧'},{id:'ride',name:'回家路况 / 呼叫快车'},{id:'coffee',name:'订咖啡 / 偏好与地址确认'},{id:'sms',name:'手机欠费短信 / Living Edge 提醒'}]}];
