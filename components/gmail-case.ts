...
export function createGmailCase():Scenario {
 ...
 const points=[{t:5200,end:5600,name:'检查绑定',title:'读取邮箱绑定记录',note:'未绑定邮箱，先发现可用连接能力。'},{t:14800,end:16950,name:'确认 Gmail',title:'用户选择 Gmail',note:'用户同意配置，邮箱尚未连接。'},{t:17600,end:18000,name:'配置卡片',title:'展示 Gmail 配置卡片',note:'等待用户按卡片指引完成配置后，再继续未读邮件摘要任务。'}];
