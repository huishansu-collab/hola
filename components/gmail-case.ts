...
export function createGmailCase():Scenario {
 ...
 const points=[{t:4400,end:4800,name:'检查绑定',title:'读取邮箱绑定记录',note:'未绑定邮箱，先发现可用连接能力。'},{t:11600,end:13400,name:'确认 Gmail',title:'用户选择 Gmail',note:'用户同意配置，邮箱尚未连接。'},{t:14000,end:14400,name:'配置卡片',title:'展示 Gmail 配置卡片',note:'等待用户按卡片指引完成配置后，再继续未读邮件摘要任务。'}];
