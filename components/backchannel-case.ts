...
// this case from a barge-in. The four units run particle, particle, sentence,
// sentence — as the venting deepens the backchannels pick up content. Venting
// is not an instruction: eight vented segments produce no tool call at all.
export function createBackchannelCase():Scenario {
 return createJsonCase(data as unknown as RawCase,timeline,[
  {t:15200,end:16400,name:'首次附和',title:'嗐 + 是啊！',tag:'助手附和',note:'连说三句后才给一次附和；压在用户人声上，用户没停。'},
  {t:26000,end:27600,name:'句中附和',title:'那真是够呛 落在语义接缝',tag:'助手附和',note:'只表示在听，不切断句子，用户照常说完后半句。'},
  ...
  {a:15600,b:16400,label:'附和词 · 是啊！',trigger:'承接上一声附和',delivery:'是啊！',annotation:'纯应和，不带内容也不评价老板；用户继续说完。'},
  {a:26000,b:27600,label:'附和句 · 那真是够呛',trigger:'长句语义接缝',delivery:'那真是够呛',annotation:'共情处境，不评判也不给建议，不切断句子。'},
