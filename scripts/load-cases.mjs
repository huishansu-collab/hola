...
export function loadCases(){
 const audio=Object.assign({},...['clips','actor-clips','ride-clips','coffee-clips','sms-clips'].map(n=>JSON.parse(fs.readFileSync(`components/audio/${n}.json`))));
