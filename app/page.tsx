...
export type Scenario=Omit<typeof weatherScenario,'events'> & {events:Array<Omit<(typeof weatherScenario)['events'][number],'overlap'>&{overlap:number[]|null}>;edited?:boolean;meta?:Record<string,unknown>;timingStatus?:'planned'|'aligned'};
