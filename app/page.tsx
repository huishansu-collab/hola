...
import {createGmailCase} from '@/components/gmail-case';
...
export default function Studio(){
 ...
 const isWeather=['weather','actor','ride','coffee','sms','gmail'].includes(activeCase.id);
