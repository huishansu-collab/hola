...
with zipfile.ZipFile(out/'Track Studio Source.zip','w',zipfile.ZIP_DEFLATED) as z:
 for item in ['app','components','lib','hooks','local','public','scripts','case-packages','skills','docs','README.md','package.json','package-lock.json','tsconfig.json','vite.local.config.ts','next.config.ts','components.json']:
  p=root/item
